  ...
  <div className="col-sm-3 mb-3 mb-sm-0">
    ...
    <img className="img-fluid rounded-circle" src="https://www.myfitnesspal.com/_next/static/media/diary.e6e4c438.svg" alt="" />
  ...
  <div className="col-sm-3">
    <div className="card text-center">
    <img className="img-fluid" src="https://www.myfitnesspal.com/_next/static/media/barcode.18277ae4.svg"/>
      <div className="card-body">
  ...
  <div className="col-sm-3">
    <div className="card text-center">
      <div>
    <img className="rounded-circle shadow" style={{objectFit: 'contain'}} src="https://www.myfitnesspal.com/_next/static/media/shoeblue.28e2684f.svg"/>
    </div>
      <div className="card-body">
