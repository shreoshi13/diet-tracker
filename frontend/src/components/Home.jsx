    ...
    <div>
      ...
      <div className="footer">
        <div className="bg-black">
          <div className="heading text-white text-center"> Contact Feedback

          </div>
          <div className="text-center text-white">Complaint</div>
          <div className="text-white text-center">Terms     Privacy</div>
          <div className="heading text-center text-white">Get Help Help Center</div>
          <div className="text-white text-center">Community Guidelines</div>
          <div className="text-center text-white">© 2023 FitnessBuddy, Inc.</div>
        </div>
      </div>
